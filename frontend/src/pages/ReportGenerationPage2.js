...
const ReportGenerationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (enableSearch && !apiKeys.serpapi) {
      setError(
        "Please provide your SerpAPI key in the settings section to enable search functionality."
      );
      setShowApiSection(true);
      return;
    }
    ...
    try {
      ...
      setStatusMessage("");
      setError(
        "Error starting report generation: " + (err.message || "Unknown error")
      );
                  ...
                  <Grid container spacing={3}>
                      ...
                      <Grid container spacing={3}>
                        ...
                        <Grid item xs={12}>
                          <TextField
                            ...
                            value={apiKeys.qwen}
                            onChange={(e) =>
                              handleApiKeyChange("qwen", e.target.value)
                            }
                        ...
                        <Grid item xs={12}>
                          <TextField
                            ...
                            onChange={(e) =>
                              handleApiKeyChange("serpapi", e.target.value)
                            }
                    ...
                    <Grid item xs={12}>
                      <Typography variant="caption" color="text.secondary">
                        ...
                        local storage and are never sent to our servers. They
                        are only used to make direct API calls to the respective
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Clearly specify the scope and focus of your report to ensure the
              content addresses your specific needs.
            </Typography>
          </Grid>
          <Grid item xs={12} md={4}>
            <Typography variant="subtitle1" fontWeight="bold">
            ...
            <Typography variant="body2">
              If you have specific requirements for the structure or sections of
              the report, mention them in your prompt.
            </Typography>
          </Grid>
          <Grid item xs={12} md={4}>
            <Typography variant="subtitle1" fontWeight="bold">
            ...
            <Typography variant="body2">
              Indicate whether you need a general overview or an in-depth
              analysis with detailed technical information and citations.
            </Typography>
          </Grid>
        </Grid>
      </Paper>
